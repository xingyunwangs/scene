...
Version 1 carries text and source context only. Image paste belongs to Mirror after handoff, so Scene does not add attachment fields to the frozen schema.
